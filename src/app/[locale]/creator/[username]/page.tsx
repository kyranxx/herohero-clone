...
const CREATORS: Record<string, {
    ...
    sarahcreates: {
        ...
        bio: "Digitálna umelkyňa a ilustrátorka zdieľajúca exkluzívne tutoriály, zákulisie tvorivého procesu a skorý prístup k novým dielam. Pridaj sa k mojej komunite 2 800+ umelcov!",
        subscribers: 2847,
        price: 5,
    ...
    techwithjames: {
        ...
        bio: "Zákulisie budovania startupov. Týždenné hlboké ponory do technológií, programovacie tutoriály a exkluzívne Q&A.",
        subscribers: 5231,
        price: 7,
...
const POSTS = [
    {
        id: "1",
        type: "video",
        title: "Nový tutoriál: Základy digitálneho maľovania",
    ...
    },
    {
        id: "2",
        type: "image",
        title: "Work in Progress - Fantasy krajina",
    ...
    },
    {
        id: "3",
        type: "video",
        title: "Záznam živého vysielania: Q&A Session",
    ...
    },
    {
        id: "4",
        type: "text",
        title: "Exkluzívne: Môj tvorivý proces odhalený",
        preview: "",
        isLocked: true,
        date: "7",
        comments: 15,
                ...
                <div className={styles.profileInfo}>
                    ...
                    <div className={styles.stats}>
                        <div className={styles.stat}>
                            <span className={styles.statValue}>{creator.subscribers.toLocaleString(locale)}</span>
                            <span className={styles.statLabel}>{t('common.subscribers')}</span>
                        </div>
                        <div className={styles.statDivider} />
                        <div className={styles.stat}>
                            <span className={styles.statValue}>{POSTS.length}</span>
                            <span className={styles.statLabel}>{t('common.posts')}</span>
                        </div>
                        <div className={styles.statDivider} />
                        <div className={styles.stat}>
                            <span className={styles.statValue}>{creator.joinedDate}</span>
                            <span className={styles.statLabel}>{t('common.joined')}</span>
                        </div>
                    </div>
                    ...
                    >
                        {isSubscribed ? (
                            ...
                            <>
                                {t('common.subscribe')} {t('common.perMonth').replace('/', `€${creator.price}/`)}
                            </>
                        )}
                    </button>
                </div>
                ...
                {activeTab === "posts" ? (
                            ...
                            >
                                    ...
                                    <div className={styles.postPreview}>
                                        ...
                                        {post.isLocked && !isSubscribed && (
                                            <div className={styles.lockedOverlay}>
                                                ...
                                                <span>{t('creator.subscribeToUnlock')}</span>
                                            </div>
                                        )}
                                        {post.type === "video" && (
                                ...
                                <div className={styles.postInfo}>
                                    ...
                                    <div className={styles.postMeta}>
                                        <span>{t('time.daysAgo', { count: post.date })}</span>
                                        <span>·</span>
                                        <span>{post.comments} {t('common.comments')}</span>
                                    </div>
                                </div>
                            </article>
                        ))}
                    ...
                    <div className={styles.aboutSection}>
                        <div className={styles.aboutCard}>
                            <h3>{t('creator.about')} {creator.displayName}</h3>
                            <p>{creator.bio}</p>
                        </div>
